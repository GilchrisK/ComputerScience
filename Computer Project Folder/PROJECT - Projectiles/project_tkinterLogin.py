...
def studentPage():
    ...
    backButton = Button(studentWindow, text="Back", command=back)
    backButton.grid(row=4, column=0, sticky="SNEW", padx=10, pady=10)
...
def adminPage():
    ...
    backButton = Button(adminWindow, text="Back", command=back)
    backButton.grid(row=4, column=0, sticky="SNEW", padx=10, pady=10)
...
student_btn = Button(login_tab, text="Student", width=20, height=5, command=studentPage, bg="light grey")
